...
public class Passenger{
    public static void main(String[] args) {
        ...
        */
        BookPassenger b1 = new BookPassenger(12, 1, "Rafat",26, true);
        BookPassenger b2 = new BookPassenger(13, 2, "Nikhat",15, false);
        BookPassenger b3 = new BookPassenger(14, 3, "Tahrim",21, false);
        b1.CustomerDetails();
        b2.CustomerDetails();
        b3.CustomerDetails();
